...
Coordinate Vessel::get_startingPoint() {
	return startingPoint;
}

Coordinate Vessel::get_endingPoint() {
	return endingPoint;
}
...
{
	long long leftNode = left.get_nodes()[0];
...
{
    long long leftNode = left.getNode1();
